function [index_AP_array, selected_Rb_array, max_selected_Rb_array, total_congested_AP, index_AP, SINR_matrix] = AP_selectionDR(bitrate, AP_SINR, selected_Rb_array, max_selected_Rb_array, index_AP_array, bitrate_AP, AP_stations, SINR_matrix)
    ...
    for ap2=1:length(AP_SINR)
            ...
            selecting_SINR(ap2) = AP_SINR(ap2);
     end
     [selected_SINR, index_AP] = max(selecting_SINR);
     selected_bitrate=selecting_bitrate(index_AP);
